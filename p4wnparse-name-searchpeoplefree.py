...
# Set lookup URL
url = 'https://searchpeoplefree.com/find/'
...
# Initialize tags to get All other data
age_tag_start = '<h3 class="mb-3">Age <span>'
#tag4 = '</div>'
age_tag_end = ' <i class="text-muted">'

# Initialize tags to get All other data
aka_tag_start = 'Known as</p><div class="col scroll-mob"><p class="many-links">'
aka_tag_end = '</p>'

name_tag_start = '<h2 class="h2">'
name_tag_end = '<span>'
...
name_reg_string = name_tag_start + '(.*?)' + name_tag_end
name_results = re.findall(name_reg_string, str(response.content))
